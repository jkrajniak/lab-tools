...
def _args():
    ...
    parser.add_argument('--ignore_missing', action='store_true',
                        help='Ignore if atom is missing in source topology')
    parser.add_argument('--value_missing', default=None, type=float, required=False,
...
def main():
    ...
    source_at_name2at_data = {at_data.name: at_data for at_data in input_top.atoms.values()}
    output_at_name2at_data = {at_data.name: at_data for at_data in output_top.atoms.values()}

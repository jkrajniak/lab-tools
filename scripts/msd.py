...
def _args():
    ...
    parser.add_argument(
        "--remove_sys_com", choices=("yes", "no"), default="yes", dest="remove_com", help="Substracts movement of whole system"
    )
...
if __name__ == "__main__":
    ...
    dt = (
        data["/particles/{}/position/time".format(args.group)][args.begin : args.end : args.step][2]

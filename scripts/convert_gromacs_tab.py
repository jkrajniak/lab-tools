...
def _args():
    ...
    gr.add_argument("--c12c6", help="Move data from 6-th column to 4-th column", action="store_true")
    gr.add_argument("--c6c12", help="Move data from 4-th columnt to 6-th column", action="store_true")
    parser.add_argument("--skip_lines", default=0, help="Number of lines to skip in input file", type=int)
    parser.add_argument("--comment_chars", default="#", help="Skip lines that starts with characters")

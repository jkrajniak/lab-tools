...
parser.add_argument(
    "-c", "--config", help="Define the config with the format chain_id:topology_file,chain_id:topology_file", required=True
)
parser.add_argument("-f", "--pdb", help="The coordinate file with the mixture.", required=True)
parser.add_argument("-o", "--out", help="The output topology file.", required=True)
